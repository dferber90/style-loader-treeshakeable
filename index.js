/*
	...
	Modified by Dominik Ferber @dferber90
*/
...
module.exports.pitch = function (request) {
	...
	var hmr = [
		...
		"",
		"		if (hasAdded) { update(newContent); } else { content = newContent }",
		"	});",
		"",
	...
	return [
		...
		"var update = require(" + loaderUtils.stringifyRequest(this, "!" + path.join(__dirname, "lib", "addStyles.js")) + ");",
		"var hasAdded;",
